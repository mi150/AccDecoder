...
class SAC_Discrete(SAC):
    ...
    def locally_save_policy(self):
        """Saves the policy"""
        torch.save(self.critic_local, "D:/shiyan/server/server/my_dds_sr_619/agents/Models/{}_local_network.pt".format(self.agent_name))
        torch.save(self.critic_local_2, "D:/shiyan/server/server/my_dds_sr_619/agents/Models/{}_local_2_network.pt".format(self.agent_name))
        torch.save(self.critic_target, "D:/shiyan/server/server/my_dds_sr_619/agents/Models/{}_target_network.pt".format(self.agent_name))
        torch.save(self.critic_target_2, "D:/shiyan/server/server/my_dds_sr_619/agents/Models/{}_target_2_network.pt".format(self.agent_name))
        torch.save(self.actor_local, "D:/shiyan/server/server/my_dds_sr_619/agents/Models/{}_actor_network.pt".format(self.agent_name))